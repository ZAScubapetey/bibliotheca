var big_image, navbar_initialized, nowuiKit, $navbar, scroll_distance, oVal, transparent = !0, transparentDemo = !0, fixedTop = !1, backgroundOrange = !1, toggle_initialized = !1;
...
$(document).ready(function() {
    ...
    768 <= $(window).width() && 0 != (big_image = $('.header[data-parallax="true"]')).length && $(window).on("scroll", nowuiKit.checkScrollForParallax),
    ...
    0 != $(".navbar[color-on-scroll]").length && (nowuiKit.checkScrollForTransparentNavbar(),
    ...
    992 <= $(window).width() && (big_image = $('.page-header-image[data-parallax="true"]'),
...
$(document).on("click", ".navbar-toggler", function() {
    $toggle = $(this),
    1 == nowuiKit.misc.navbar_menu_visible ? ($("html").removeClass("nav-open"),
    ...
    $(div).appendTo("body").click(function() {
        ...
        setTimeout(function() {
            $toggle.removeClass("toggled"),
            $("#bodyClick").remove(),
            0 != $("#navbar-right").length && 0 != $("#navbar-middle").length && ($("#navbar-right").append($("#navbar-middle>.navbar-extend")),
            $("#navbar-right").find(".navbar-extend").removeClass("navbar-extend"))
        }, 550)
    }),
    $("html").addClass("nav-open"),
    nowuiKit.misc.navbar_menu_visible = 1,
    0 != $("#navbar-right").length && 0 != $("#navbar-middle").length && ($("#navbar-right").find("li").addClass("navbar-extend"),
...
nowuiKit = {
    ...
    checkScrollForTransparentNavbar: debounce(function() {
        $(document).scrollTop() > scroll_distance ? transparent && (transparent = !1,
