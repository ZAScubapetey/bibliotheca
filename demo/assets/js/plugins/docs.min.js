!(function (e, t) {
  ...
  "function" == typeof define && define.amd
    ...
    ? (module.exports = t())
    : ((e.AnchorJS = t()), (e.anchors = new e.AnchorJS()));
})(this, function () {
  "use strict";
  function e(e) {
    function t(e) {
      (e.icon = e.hasOwnProperty("icon") ? e.icon : ""),
        ...
        (e.truncate = e.hasOwnProperty("truncate")
          ? Math.floor(e.truncate)
          : 64);
    }
    function n(e) {
      var t;
    ...
    (this.options = e || {}),
      ...
      (this.add = function (e) {
        ...
        for (
          ...
          if (this.hasAnchorJSLink(i[l])) g.push(l);
          else {
            if (i[l].hasAttribute("id")) s = i[l].getAttribute("id");
            else {
              (h = this.urlify(i[l].textContent)), (d = h), (u = 0);
              do {
                void 0 !== c && (d = h + "-" + u), (c = a.indexOf(d)), (u += 1);
              } while (-1 !== c);
              (c = void 0), a.push(d), i[l].setAttribute("id", d), (s = d);
            }
            (f = s.replace(/-/g, " ")),
              ...
              "left" === this.options.placement
                ? ((A.style.position = "absolute"),
                  ...
                  i[l].insertBefore(A, i[l].firstChild))
                : ((A.style.paddingLeft = "0.375em"), i[l].appendChild(A));
          }
        for (l = 0; l < g.length; l++) i.splice(g[l] - l, 1);
        return (this.elements = this.elements.concat(i)), this;
      }),
      (this.remove = function (e) {
        for (var t, r, i = n(e), o = 0; o < i.length; o++)
          (r = i[o].querySelector(".anchorjs-link")) &&
            ((t = this.elements.indexOf(i[o])),
      ...
      (this.hasAnchorJSLink = function (e) {
        var t =
            e.firstChild &&
            (" " + e.firstChild.className + " ").indexOf(" anchorjs-link ") >
              -1,
          n =
            e.lastChild &&
            (" " + e.lastChild.className + " ").indexOf(" anchorjs-link ") > -1;
        return t || n || !1;
      });
  }
  return e;
      ...
      t.querySelectorAll ||
        ...
        t.getElementsByClassName ||
          (t.getElementsByClassName = function (e) {
            return (
              (e = String(e).replace(/^|\s+/g, ".")), t.querySelectorAll(e)
            );
          }),
        Object.keys ||
        ...
        (function () {
          if (
            ("performance" in e == 0 && (e.performance = {}),
            (Date.now =
              Date.now ||
              function () {
    ...
    return (function (e) {
            ...
            if (
              ...
              if (
                ...
                l.theme &&
                  ...
                  (n.theme = S(n.instanceOptions.themes[l.theme], null)),
          ...
          function o(e) {
            ...
            if (
              (r.font &&
                ...
                !p.noFontFallback &&
                  ...
                  "svg" === p.renderer &&
                  (p = S(p, { renderer: "canvas" }))),
              r.font && "canvas" == p.renderer && (p.reRender = !0),
              "background" == t)
            )
              null == n.getAttribute("data-background-src") &&
                b.setAttr(n, { "data-background-src": A });
            else {
              var g = {};
              (g[O.vars.dataAttr] = A), b.setAttr(n, g);
            }
            (r.theme = s),
              (n.holderData = { flags: r, engineSettings: p }),
              ("image" != t && "fluid" != t) ||
                b.setAttr(n, { alt: s.text ? s.text + " [" + l + "]" : l });
            var m = {
              mode: t,
              el: n,
            ...
            "image" == t
              ...
              : "fluid" == t &&
                ...
                "html" == p.renderer
                  ? (n.style.backgroundColor = s.bg)
                  : (O.vars.resizableImages.push(n), c(n)));
          }
          function a(e) {
            function n() {
              var t = null;
            ...
            var c = {
              ...
              u = s(c);
            if (null == (r = n())) throw "Holder: couldn't render placeholder";
            "background" == i
              ? ((o.style.backgroundImage = "url(" + r + ")"),
                l.noBackgroundSize ||
                  (o.style.backgroundSize = c.width + "px " + c.height + "px"))
              : ("img" === o.nodeName.toLowerCase()
                  ? b.setAttr(o, { src: r })
                  : "object" === o.nodeName.toLowerCase() &&
                    b.setAttr(o, { data: r, type: "image/svg+xml" }),
                l.reRender &&
                  t.setTimeout(function () {
                    ...
                    "img" === o.nodeName.toLowerCase()
                      ? b.setAttr(o, { src: e })
                      : "object" === o.nodeName.toLowerCase() &&
                        b.setAttr(o, { data: e, type: "image/svg+xml" });
                  }, 150)),
              b.setAttr(o, { "data-holder-rendered": !0 });
          }
          function s(e) {
            function t(e, t, n, r) {
              (t.width = n),
            ...
            var r = e.flags.lineWrap || O.setup.lineWrapRatio,
              i = e.width * r,
              o = i,
              a = new m({ width: e.width, height: e.height }),
              s = a.Shape,
              c = new s.Rect("holderBg", { fill: e.theme.bg });
            if ((c.resize(e.width, e.height), a.root.add(c), e.flags.outline)) {
            ...
            p.moveTo(null, null, 1), a.root.add(p);
            ...
            if (g.lineCount > 1) {
              ...
              for (var S = 0; S < g.words.length; S++) {
                ...
                !e.noWrap &&
                  ...
                  (y.y = E)),
                  T !== !0 &&
                    (v.moveTo(x, 0), (x += g.spaceWidth + k.width), y.add(v));
              }
              if (
                (t(p, y, x, p.properties.leading), p.add(y), "left" === e.align)
              )
                p.moveTo(e.width - i, null, null);
              else if ("right" === e.align) {
                for (b in p.children)
                  (y = p.children[b]), y.moveTo(e.width - y.width, null, null);
              ...
              (v = new s.Text(e.text)),
                ...
                "left" === e.align
                  ...
                  : "right" === e.align
                  ? p.moveTo(0 - (e.width - i), null, null)
                  : p.moveTo((e.width - g.boundingBox.width) / 2, null, null),
          ...
          var p = n(2),
            ...
            j = {
              ...
              addImage: function (e, t) {
                return (
                  b.getNodeArray(t).forEach(function (t) {
                    var n = b.newEl("img"),
                      r = {};
                  ...
                  if (c > 1) {
                    ...
                    for (var g = 0; g < u.length; g++)
                      if (0 !== u[g].length) {
                        ...
                        var m = t.getBBox();
                        p.push({ text: u[g], width: m.width });
                      }
                  }
                  return (
                    (e.style.display = "none"),
                    { spaceWidth: A, lineCount: c, boundingBox: l, words: p }
                  );
                }
                return !1;
              };
            ...
            (function () {
              ...
              e.getContext &&
                ...
                document.createElementNS &&
                  document.createElementNS(T, "svg").createSVGRect &&
                ...
                O.vars.preempted || j.run(),
                  t.addEventListener
                    ? (t.addEventListener("resize", A, !1),
                      t.addEventListener("orientationchange", A, !1))
          ...
          (function (e) {
            function t(e) {
              if (!w) {
                ...
                for (w = !0; (e = x.shift()); ) i(e);
              }
            }
            function n(e) {
              (y || e.type === l || a[d] === h) && (r(), t());
            }
            function r() {
              y ? (a[v](g, n, c), e[v](l, n, c)) : (a[A](m, n), e[A](u, n));
            }
            function i(e, t) {
        ...
        (t.parse = function (e) {
          ...
          for (var t = {}, n = e.split("&"), r = 0; r < n.length; r++) {
            var a,
              ...
              d = i(h[0]);
            if ((a = s.exec(d)))
              (t[a[1]] = t[a[1]] || []), (t[a[1]][a[2]] = i(h[1]));
            else if ((a = l.test(d))) {
              for (a = d.split("."), c = t; a.length; )
      ...
      function (e, t) {
        var n = function (e) {
          ...
          var c = new i();
          return (
            (this.Shape = { Rect: s, Text: l, Group: a }), (this.root = c), this
          );
        };
        e.exports = n;
      },
        ...
        (function (e) {
          ...
          (t.initSVG = function (e, t, n) {
            var o,
              ...
              s = !1;
            e && e.querySelector
              ? null === (a = e.querySelector("style")) && (s = !0)
              : ((e = r.newEl("svg", i)), (s = !0)),
              s &&
                ((o = r.newEl("defs", i)),
                (a = r.newEl("style", i)),
                r.setAttr(a, { type: "text/css" }),
                o.appendChild(a),
                e.appendChild(o)),
              ...
              return function (t, n) {
                return n
                  ? "data:image/svg+xml;charset=UTF-8;base64," +
                      btoa(e.unescape(encodeURIComponent(t)))
      ...
      function (e, t, n) {
        ...
        e.exports = function (e, t) {
          ...
          A.y += 0.8 * A.textPositionData.boundingBox.height;
          var g = [];
          ...
          var m = h.element({ tag: "g", content: g }),
            v = null;
          ...
          var b = r(f.children.holderBg, "rect"),
            w = [];
          w.push(b), y && w.push(v), w.push(m);
          var x = h.element({ tag: "g", id: d, content: w }),
            E = h.element({ tag: "style", content: p, type: "text/css" }),
            C = h.element({ tag: "defs", content: E }),
            S = h.element({
              tag: "svg",
              content: [C, x],
            ...
            k = a(S);
          return (
            (k = c + k[0]), s.svgStringToDataURI(k, "background" === t.mode)
          );
        };
      },
      function (e, t, n) {
        n(14),
          (e.exports = function e(t, n, r) {
            ...
            var o,
              ...
              c = 1,
              u = !0;
            if (((r = r || {}), "string" == typeof t[0]))
              t[0] = (function (e) {
                var t = e.match(/^[\w-]+/),
                  n = { tag: t ? t[0] : "div", attr: {}, children: [] },
                  i = e.match(/#([\w-]+)/),
                  o = e.match(/\$([\w-]+)/),
                  a = e.match(/\.[\w-]+/g);
                return (
                  i && ((n.attr.id = i[1]), (r[i[1]] = n)),
                  o && (r[o[1]] = n),
              ...
              if (void 0 !== t[c] && t[c] !== !0)
                if ("string" == typeof t[c])
                  ...
                  if (Array.isArray(t[c][0])) {
                    if (
                      (t[c].reverse().forEach(function (e) {
                        t.splice(c + 1, 0, e);
                      }),
                      0 !== c)
                    )
                  ...
                  e(t[c], n, r), t[c][0] && t[0].children.push(t[c][0]);
                } else if ("function" == typeof t[c]) s = t[c];
                else {
                  if ("object" != typeof t[c])
                    throw new TypeError(
                      '"' + t[c] + '" is not allowed as a value.'
                    );
                  for (a in t[c])
                    t[c].hasOwnProperty(a) &&
                      null !== t[c][a] &&
                      t[c][a] !== !1 &&
                      ("style" === a && "object" == typeof t[c][a]
                        ? (t[0].attr[a] = JSON.stringify(t[c][a], i)
                            .slice(2, -2)
                            .replace(/","/g, ";")
                            .replace(/":"/g, ":")
                            .replace(/\\"/g, "'"))
